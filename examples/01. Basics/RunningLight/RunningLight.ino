...
/*      Inovatic-ICT d.o.o                                                                                  */
/*                                                                                                          */
/*      EMoRo Example:      Running Light                                                                   */
/*      Board name:         EMoRo 2560 v3.2                                                                 */
/*      MCU name:           ATMEGA2560-16                                                                   */
/*      Clock:              16 MHz                                                                          */
/*      File description:                                                                                   */
/*            Turns LED IO_0 on for 100 milliseconds, then turns it off for 100 milliseconds.               */
/*            After LED IO_0 repeat the same procedure for next LEDs up to IO_15.                           */
/*            After IO_15 LED start again wiht IO_0 LED.                                                    */
/*      Necessary equipment:                                                                                */
...
void loop() {
  for(i=0;i<=IO_15;i++){          // swipe trough pins IO_0 to IO_15 
