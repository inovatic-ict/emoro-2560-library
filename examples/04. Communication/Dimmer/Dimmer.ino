...
/*      Inovatic-ICT d.o.o									                                                                */
/*												                                                                                  */
/*      EMoRo Example:		  Dimmer                                                                          */
/*      Board name: 		    EMoRo 2560 v3.2	                                          					            */
/*      MCU name:		        ATMEGA2560-16					                                                          */
/*      Clock:			        16 MHz						                                                              */
/*      File description:                                                                                   */
/*            Demonstrates the sending data from the computer to the Arduino board, in this case to         */
/*            control the brightness of Status LED on EMoRo2560 controller.  The data is sent in individual */
/*            bytes, each of which ranges from 0 to 255.  Arduino reads these bytes and uses them to set    */
...
/*                          Max/MSP, or another serial application                                          */
...
void loop() {
  byte brightness;                              // initialize variable brightness
