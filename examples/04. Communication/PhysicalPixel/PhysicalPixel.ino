...
/*      Inovatic-ICT d.o.o								                                                    	            */
/*												                                                                                  */
/*      EMoRo Example:		  Physical Pixel                                                                  */
/*      Board name: 		    EMoRo 2560 v3.2	                                          					            */
/*      MCU name:		        ATMEGA2560-16					                                                          */
/*      Clock:			        16 MHz						                                                              */
/*      File description:                                                                                   */
/*            An example of using the EMoRo 2560 board to receive data from the computer.  In this case,    */ 
/*            the EMoRo 2560 board turns on an LED when it receives the character 'H', and turns off the    */
/*            LED when it receives the character 'L'.                                                       */
/*            In this example the LED attached to IO_0 is used.                                             */
/*            The data can be sent from the Arduino serial monitor, or another program like Processing      */
/*            (see code below), Flash (via a serial-net proxy), PD, or Max/MSP.                             */
/*                                                                                                          */
/*      Necessary equipment:                                                                                */
...
const int ledPin = IO_0;              // the pin that the LED is attached to
